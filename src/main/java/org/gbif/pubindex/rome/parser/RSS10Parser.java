 ...
 *
 */
package org.gbif.pubindex.rome.parser;
...
/**
 * A patched version of the original ROME parser that also checks the channel element for the RSS namespace.
 * The original only checks the root element for all declared namespaces and therefore fails to parse various correct feeds.
 */
public class RSS10Parser extends RSS090Parser {
  ...
  public boolean isMyType(Document document) {
    ...
    if (ok) {
      // now also test if the channel element exists with the right namespace
